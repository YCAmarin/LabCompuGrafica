//Practica 5		Marín Alva Yulen Caleb Alher
//13/03/2026		320089756
#include<iostream>
#include <GL/glew.h>
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model Pulgar A
		model = glm::translate(modelTemp2, glm::vec3(-0.1f, 0.0f, 0.5f));
 ...
 void Inputs(GLFWwindow *window) {
	 ...
	 if (glfwGetKey(window, GLFW_KEY_Q) == GLFW_PRESS) {
		 dedo1 -= 0.5f; dedo2 -= 0.5f;
		 dedo3 -= 0.5f; dedo4 -= 0.5f;
		 dedo5 -= 0.5f; dedo6 -= 0.5f;
		 dedo7 -= 0.5f; dedo8 -= 0.5f;
		 pulgar1 -= 0.3f; pulgar2 -= 0.5f;
	 }
	 ...
	 //Limitando el accionar de los dedos
	 dedo1 = glm::clamp(dedo1, -90.0f, 0.0f);
	 dedo2 = glm::clamp(dedo2, -90.0f, 0.0f);
	 dedo3 = glm::clamp(dedo3, -90.0f, 0.0f);
	 dedo4 = glm::clamp(dedo4, -90.0f, 0.0f);
	 dedo5 = glm::clamp(dedo5, -90.0f, 0.0f);
	 dedo6 = glm::clamp(dedo6, -90.0f, 0.0f);
	 dedo7 = glm::clamp(dedo7, -90.0f, 0.0f); 
	 dedo8 = glm::clamp(dedo8, -90.0f, 0.0f); 
	 pulgar1 = glm::clamp(pulgar1, -45.0f, 0.0f);
	 pulgar2 = glm::clamp(pulgar2, -90.0f, 0.0f);
